...
- Table of Required Routes
    ...
    | /product/:id       | GET           | show            | read            | showProduct.ejs |
    | /new               | GET           | new             | read            | newProduct.ejs  |
    | /books/                  | POST          | create          | create          |                  |
    | /product/:id/edit  | GET           | edit            | read            | editProduct.ejs |
    | /product/:id       | PATCH/PUT     | update          | update          |                  |
    | /product/:id       | DELETE        | destroy         | delete          |                  |
